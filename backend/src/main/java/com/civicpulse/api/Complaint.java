...
public class Complaint {
    ...
    public Complaint(String id, String title, String description, String category,
                     String priority, String status, double lat, double lng, boolean emergency) {
        this.id=id; this.title=title; this.description=description; this.category=category;
        this.priority=priority; this.status=status; this.lat=lat; this.lng=lng; this.emergency=emergency;
    }
}
